...
BOOST_AUTO_TEST_CASE(test_lex_offset_datetime)
{
...
BOOST_AUTO_TEST_CASE(test_lex_local_datetime)
{
...
BOOST_AUTO_TEST_CASE(test_lex_local_date)
{
    TOML11_TEST_LEX_ACCEPT(lex_local_date, "1979-05-27", "1979-05-27");
}
BOOST_AUTO_TEST_CASE(test_lex_local_time)
{
